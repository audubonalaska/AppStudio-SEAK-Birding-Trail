    ...
    contentItem: Rectangle {
        ...
        ColumnLayout {
            ...
            Button {
                ...
                visible: true //!isSigningInIndicator.visible && app.isEmbedded
                text: kStart //app.itemId > ""?kSignIn: (app.supportSecuredMaps ? kSignIn : kStart)
            ...
            Controls.BaseText {
                ...
                visible: false //startBtn.visible && startBtn.text === startBtn.kSignIn && app.enableAnonymousAccess && app.isEmbedded
                text: qsTr("Skip")
                color: app.titleTextColor
                horizontalAlignment: Text.AlignHCenter
